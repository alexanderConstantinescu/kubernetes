...
// ShutDownWithDrain will return. It is safe to call ShutDown after having
// called ShutDownWithDrain, as to force the queue shut down to terminate
// immediately without waiting for the drainage, if needed.
