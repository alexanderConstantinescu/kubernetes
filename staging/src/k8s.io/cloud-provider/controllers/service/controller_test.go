...
func TestNodeChangesForExternalTrafficPolicyLocalServices(t *testing.T) {
	...
	services := []*v1.Service{
		newETPLocalService("s0", "777", v1.ServiceTypeLoadBalancer),
		newETPLocalService("s1", "888", v1.ServiceTypeLoadBalancer),
		newETPLocalService("s3", "999", v1.ServiceTypeLoadBalancer),
		newETPLocalService("s4", "123", v1.ServiceTypeLoadBalancer),
	}
